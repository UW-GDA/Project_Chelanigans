...
## Short summary  
During the 2021 Pacific Northwest heatwave from June 22 to July 2, the glaciers which feed Lake Chelan likely underwent some level of rapid melt event. When such an event occurs, fine grained sediment, called glacial flour, will be transported with the meltwater to the lake [2]. This causes the lake to be cloudy which blocks light attenuation, disrupting several biotic processes [3][4][5]. This study will attempt to quantify the abundance of glacial turbidity within a glacially fed lake; before, during, and after a presumed rapid glacial melt event. 
...
# Beyond turbidity, glacial flour is also known to contain high concentrations of phosphorus [2][5]. Phosphorus is often a limiting nutrient for growth in aquatic environments and additional sources of phosphorus will often lead to phytoplankton blooms [3]. The increased influx of glacial flour caused by climate change will create more turbid waters and likely disrupt biogeochemical balances which will ultimately impact aquatic life negatively.  
...
As water is a dark target from space, it is extremely difficult to assess water quality using satelite imagery. However, it has been shown that changes in turbidity can be tracked by satelite imagery using ratios of raster bands from the visible and near-infrared spectra [7][8][9].  
...
Sentinel-2. https://cloud.google.com/storage/docs/public-datasets/sentinel-2#dataset_access [10]     
...
Harmonized Landsat-8 & Sentinel-2 (HLS) [11]  
...
* Phase 2    
    1. Find correct rgb/nir ratios to identify glacial turbidity  
    2. Develop a notebook that will track temporal changes in abundance (area) and/or intensity  
* Phase 3
    1. Create a timeseries to visualize seasonal variation across all years  
    2. Create a timeseries to visualize annual trends in mean, median, std (since 2016)  
...
| <font size='4'>Normalized Difference Turbidity Index [7]</font> |  
|:---|  
| <font size='3'>$$NDTI = (red-green) / (red+green)$$</font> |  

| <font size='4'>Normalized Difference Suspended Solids Index [8]</font> |  
|:---|  
...
<figure>
    <img src="./output/chelan_0_query-data_2021/bokeh_plot_full.png"
         alt="figure of available shots, characterized by cloud cover"
         title="figure of available shots, characterized by cloud cover"         
         width="700"/>
...
<figure>
    <img src="./output/chelan_0_query-data_2021/bokeh_plot.png"
         alt="figure of available shots with less than 20% cloud cover"
         title="figure of available shots with less than 20% cloud cover"         
         width="700"/>
...
<figure>
    <img src="./output/chelan_1_site-exploration/lucerne_basin/natural-color-comp-timeseries.png"
         alt="full-expanse, natural-color-composition timeseries 2021-07-11"
         title="full-expanse, natural-color-composition timeseries 2021-07-11"         
         width="800"/>
...
<figure>
    <img src="./output/chelan_2_rgb-analysis/lucerne_basin/red-signal_2021-09-24.png"
         alt="lucerne-basin, red-signal 2021-09-24"
         title="lucerne-basin, red-signal 2021-09-24"         
         width="600"/>
...
<figure>
    <img src="./output/chelan_2_rgb-analysis/lucerne_basin/green-signal_2021-09-24.png"
         alt="lucerne-basin, green-signal 2021-09-24"
         title="lucerne-basin, green-signal 2021-09-24"         
         width="600"/>
...
<figure>
    <img src="./output/chelan_2_rgb-analysis/lucerne_basin/blue-signal_2021-09-24.png"
         alt="lucerne-basin, blue-signal 2021-09-24"
         title="lucerne-basin, blue-signal 2021-09-24"         
         width="600"/>
...
<figure>
    <img src="./output/chelan_2_rgb-analysis/lucerne_basin/masked-RGB-signals.png"
         alt="lucerne-basin, masked-RGB-signals 2021-09-24"
...
<figure>
    <img src="./output/chelan_2_rgb-analysis/lucerne_basin/visualize-normalization.png"
         alt="lucerne-basin, visualize-normalization 2021-09-24"
         title="lucerne-basin, visualize-normalization 2021-09-24"         
         width="700"/>
...
<figure>
    <img src="./output/chelan_2_rgb-analysis/lucerne_basin/index-ratio-comparison.png"
         alt="lucerne-basin, index-ratio-comparison 2021-09-24"
         title="lucerne-basin, index-ratio-comparison 2021-09-24"         
         width="700"/>
...
<figure>
    <img src="./output/chelan_4_affected-area-analysis/upper_lucerne_basin/model-configuration-histogram_wrong.png"
         alt="lucerne-basin, model-configuration-histogram wrong 2021-09-24"
         title="lucerne-basin, model-configuration-histogram wrong 2021-09-24"         
         width="700"/>
...
<figure>
    <img src="./output/chelan_4_affected-area-analysis/upper_lucerne_basin/model-configuration-histogram_2021-09-24.png"
         alt="lucerne-basin, model-configuration-histogram 2021-09-24"
         title="lucerne-basin, model-configuration-histogram 2021-09-24"         
         width="700"/>
...
<figure>
    <img src="./output/chelan_4_affected-area-analysis/upper_lucerne_basin/NDTI_thresh_timeseries.png"
         alt="upper-lucerne-basin, NDTI_thresh_timeseries 2021-07-11"
         title="upper-lucerne-basin, NDTI_thresh_timeseries 2021-07-11"         
         width="800"/>
...
<figure>
    <img src="./output/chelan_4_affected-area-analysis/upper_lucerne_basin/NDSSI_thresh_timeseries.png"
         alt="upper-lucerne-basin, NDSSI_thresh_timeseries 2021-07-11"
         title="upper-lucerne-basin, NDSSI_thresh_timeseries 2021-07-11"         
         width="800"/>
...
<figure>
    <img src="./output/chelan_4_affected-area-analysis/upper_lucerne_basin/NDTI-NDSSI-signals-timeseries.png"
         alt="upper-lucerne-basin, NDTI-NDSSI-signals-timeseries 2021-07-11"
         title="upper-lucerne-basin, NDTI-NDSSI-signals-timeseries 2021-07-11"         
         width="700"/>
...
## Lessons Learned  
  * Stage your code to handle pairs or triplets. This makes it easier to scale up when ready.
  * Avoid downloads from the beginning. This will be easier than beginning with downloads and readapting back to a more efficient way.
...
## References  
[1] 
https://www.visitchelancounty.com/lake-chelan#iLightbox[gallery_image_1]/0

[2] 
D. P. Coduto, M. R. Yeung, W. A. Kitch, Geotechnical Engineering: Principles and Practice. pp. 43-54. Upper Saddle River, NJ: Prentice Hall Inc, 1999.

[3] 
E. B. Welch and J. M. Jacoby, Pollutant Effects in Freshwater: Applied Limnology, London: Spon Press, 2004. 
